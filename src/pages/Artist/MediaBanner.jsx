...
export default function MediaBanner(props) {
  const { mediaId, spotifyURL, color, image, name, artistName, subtitle } =
    props;
  ...
  return (
    ...
    >
      ...
      <div className="flex h-full flex-col items-center justify-center gap-2 p-2">
        <div className="m-auto flex w-80 flex-col items-center gap-2">
          {name ? (
        ...
        <div>
          ...
          {subtitle ? <p>{subtitle || ""}</p> : <Placeholder />}
        </div>
      </div>
    </div>
  );
